...
const TableOfContents = ({ headings, location }: Props) => {
  ...
  const innerStyle = `${styles['toc']} ${styles['toc--inner']}`;

  return (
    <nav className={`${location === 'inner' ? innerStyle : styles['toc']}` }>
     <div className={styles['toc__wrapper']}>
